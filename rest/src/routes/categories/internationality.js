...
internationality.get(`/${identifier}`, (request, result, next) => {
...
internationality.get(`/${identifier}/:id`, (request, result, next) => {
  db.query(
...
internationality.post(`/${identifier}`, (request, result, next) => {
  let keys = "";
  let values = "";
...
internationality.delete(`/${identifier}/:id`, (request, result, next) => {
...
internationality.put(`/${identifier}/:id`, (request, result, next) => {
  let qparams = "";
